...
int main() {
	...
	// ifstream infile("/Users/tetsuya/Documents/Projects/C++/Projects/CSS502A/HW2/data2.txt");
	// if (!infile) {
	...
	string str9 = "I";
	string str10 = "J";
	NodeData* nd1 = new NodeData(str1);
	NodeData* nd2 = new NodeData(str2);
	NodeData* nd3 = new NodeData(str3);
	NodeData* nd4 = new NodeData(str4);
	NodeData* nd5 = new NodeData(str5);
	NodeData* nd6 = new NodeData(str6);
	NodeData* nd7 = new NodeData(str7);
	NodeData* nd8 = new NodeData(str8);
	NodeData* nd9 = new NodeData(str9);
	NodeData* nd10 = new NodeData(str10);
